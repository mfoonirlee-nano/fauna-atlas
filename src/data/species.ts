...
export const species = [
  ...
  },
  {
    ...
    distribution: {
      ...
      range: '环热带及暖温带海域广布，通常约见于 30°N—35°S，边界随季节和暖水伸缩，偶尔扩展到更高纬度；国家列表收录代表性范围国与聚集地。',
    ...
    habitats: [
      ...
      },
      {
        name: '远洋中层与深层水域',
        realm: 'marine',
        description: '垂直移动时会短时进入中深层乃至更深水层；深潜记录出自个别个体，日常活动仍在较浅的水层。',
      },
    ],
    measurements: {
      length: {
        max: 18.8,
        unit: 'm',
        note: '历史资料中较可靠的最大纪录之一；常见成体远小于此，极值测量也受方法限制。',
      },
    },
    diet: {
      ...
      description: '兼用张口前游的冲压滤食与口咽泵吸；水流沿滤垫形成交叉流，把小型猎物集中后吞咽。宁格鲁礁的研究还从其体内检出马尾藻等植物来源物质，多半是随滤食顺带进入、被一并同化的。',
    },
    activity: [
      '通常单独活动',
      '季节性摄食聚集',
    ...
    storySections: [
      {
        ...
        label: '形态与身份',
        title: '星图一样的斑点身份证',
        body: '宽扁的头部、吻端的大口、五对鳃裂和三条体侧隆起勾出鲸鲨的轮廓。鳃后到胸鳍上方那片斑点组合经照片与遗传双重核验，多年间保持稳定，足以认出一个个具体的它。至于全球每条鲸鲨是否都有一套独一无二的斑纹，证据还追不到那么远。',
      },
      {
        key: 'filter-feeding',
        label: '滤食机制',
        title: '一张会游的滤网',
        body: '鲸鲨既张口前游着滤食，也会用口咽泵吸进海水。20 块滤垫引导水流沿滤面掠过，交叉流把桡足类、磷虾、鱼卵和鱼类幼体聚拢成形，一口咽下。',
      },
      {
        key: 'migration',
        label: '聚集与迁游',
        title: '从季节餐桌游向大洋',
        body: '鲸鲨惯于独行，却会在产卵或浮游生物暴发形成的食物热点短期聚集。个体既可能重返同一处聚集地，也能跨越洋盆：一条成年雌性用 841 天游出 20,142 千米。换一条鲨鱼，路线便是另一番走法。',
      },
      {
        key: 'vertical-ocean',
        label: '垂直海洋',
        title: '表层巨影也会潜入两千米以下',
        body: '2026 年，一条约 7 米长的幼年雄性留下最深下潜记录：综合定制标签、水温压力和海底地形推算，深度落在 1,978—2,527 米之间，上界仍带测量误差。这个数字丈量的是垂直活动的潜力，日常的活动水层要浅得多。',
      },
      {
        key: 'life-history',
        label: '生长与繁殖',
        title: '最大的鱼，留下巨大的知识空白',
        body: '放射性碳校准已确认样本中有 50 岁的个体，真实的寿命上限还是未知数。鲸鲨行无胎盘胎生；人们对繁殖的了解，大多来自 1995 年取得的一条怀孕雌性和她腹中 304 个发育阶段各异的胚胎。至于交配发生在哪里、妊娠多久、在哪里产仔，至今没有一处落实。',
      },
      {
        key: 'conservation',
        label: '保护与监测',
        title: '跨越大洋的鲨，需要跨越大洋的保护',
        body: 'IUCN 在 2025 年继续将鲸鲨评为濒危；IUCN 与 TRAFFIC 为 CITES CoP20 所作的分析估计，过去三个世代、约 120 年间，全球种群下降了 50%—79%。而它们偏偏偏爱船舶来往的表层水域。贸易管制、渔业安全释放、航运减速改道、规范观鲨、跨境监测，每一环都要接得上，才护得住这条横越大洋的鱼。',
      },
    ],
    keyFacts: [
      '名叫鲸鲨，其实是鱼：软骨鱼纲、鲸鲨科唯一现生种，也是现生最大的鱼类。',
      '鳃后的斑点组合经照片与遗传核验可识别到个体，并在多年间保持稳定。',
      '滤食兼用前游冲压与口咽泵吸，20 块滤垫靠交叉流把小型食物聚拢入口。',
      '2026 年一条幼年雄性的最深下潜推断在 1,978—2,527 米之间；极端记录，日常水层要浅得多。',
      '一条成年雌性的跨太平洋追踪轨迹约 20,142 千米；每个个体各有各的路线。',
      '放射性碳校准确认了 50 岁的样本个体；真实的寿命上限仍未知。',
      '1995 年取得的怀孕雌性怀有 304 个发育阶段各异的胚胎；关键产仔场至今未明。',
    ],
    threats: [
      '定向捕捞以及围网、刺网等渔业兼捕',
    ...
    featuredStats: [
      ...
      },
      {
        ...
        value: '50—79',
        unit: '%',
        note: 'IUCN/TRAFFIC 为 CoP20 所作分析；由区域资料汇总推算的区间',
      },
    ],
    media: {
      ...
      gallery: [
        ...
        },
        {
          ...
          title: '潜入深水',
          caption: '2026 年一条幼年雄性的最深下潜推断在 1,978—2,527 米之间；单个极端记录，日常的水层要浅得多。',
          focalPoint: { x: 0.54, y: 0.55 },
        },
        {
          ...
          title: '季节性的相遇',
          caption: '短暂而密集的食物脉冲，让惯于独行的鲸鲨凑到同一片海域；散席之后，各自继续上路。',
          focalPoint: { x: 0.5, y: 0.48 },
        },
      ],
    },
  ...
  },
  {
    ...
    habitats: [
      ...
      },
      {
        ...
        realm: 'terrestrial',
        description:
          '成年个体会穿行和伏击于季节性干燥的稀树草原、林地、草地与灌丛；开阔地只是这幅镶嵌画的一部分。',
      },
      {
        name: '河岸带、红树林与沿海避难生境',
        realm: 'terrestrial',
    ...
    measurements: {
      length: {
        max: 3.04,
        unit: 'm',
        note: '雄性全长纪录；雌性纪录 2.67 米，两笔都是极值',
      },
    },
    diet: {
      types: ['carnivore'],
      ...
      description:
        '幼体主动搜索小型猎物；体型超过约 20 千克后，更常伏击大型脊椎动物。后弯锯齿牙切开组织，颈部和身体后拉扩大伤口，下颌毒腺分泌物可加重失血和低血压。真正的主攻手是牙齿与毒液，口腔细菌至多算帮凶。',
    },
    ...
    storySections: [
      {
        ...
        title: '三米纪录，只属于最大的雄性',
        body:
          '它是现生体长最大的蜥蜴，雄性全长纪录 3.04 米、雌性纪录 2.67 米。长期研究种群中，成年雄性约 70 千克、雌性约 25 千克；岛上猎物的多寡，还让不同种群的个头分出了量级。背脊平直、鳞甲粗粝，是巨蜥的模样放大到极致。',
      },
      {
        key: 'chemical-trail',
        label: '感官',
        title: '舌头采样，犁鼻器判断方向',
        body:
          '黄色分叉舌不断伸缩，分别从左右两侧带回化学颗粒，再送入口腔顶部成对的犁鼻器。全基因组研究发现的犁鼻受体扩张，正与这份发达的化学感知相符；自然史资料还说，它能循着气味找到数千米外的受伤动物或腐肉，具体远近随个体与情境而变。',
      },
      {
        key: 'bite-and-pull',
        label: '捕猎',
        title: '咬住，然后往后拉',
        body:
          '后弯锯齿牙先切开组织，巨蜥再用颈部、四肢和身体向后拉扯；下颌毒腺分泌物在一旁放大出血和低血压。杀死大型猎物靠的是这一整套耐心的动作，一口“毒杀”反倒是以讹传讹。',
      },
      {
        key: 'tree-childhood',
        label: '成长',
        title: '先在树上长大，再到地面伏击',
        body:
          '刚出巢的幼体更纤细，身上有醒目的黄黑或橙黑斑带，主要在树上寻找昆虫、小蜥蜴和鸟类，顺便躲开会吃掉它们的成年同类。随着身体变重，树栖活动下降，食谱和捕猎方式一起转向大型地面猎物。',
      },
      {
        ...
        body:
          '2024 年官方监测覆盖科莫多、林卡、吉利莫堂、努沙科德和帕达尔五岛；国家公园外的弗洛勒斯沿岸和近岸小岛仍保有分散种群。小岛之间彼此隔离，每一处栖息地和遗传单元都独一无二，失去了便难以复原。',
      },
      {
        ...
        title: '公园内的稳定，群岛间的压力',
        body:
          '国家公园 2024 年估计有 3,270 ± 371 只各年龄个体，近年总体稳定；IUCN 的全球评估却仍是濒危、下降。弗洛勒斯生境破碎、猎物盗猎、犬、道路和非法捕捉都在发生，海平面上升和气候变化还会把沿海窄域的风险推向未来。',
      },
    ],
    keyFacts: [
      '黄色分叉舌采集化学颗粒，成对犁鼻器负责分析；循迹数千米之说出自自然史资料，远近随情境而变。',
      '幼体高度树栖、斑纹鲜明，随体型增长转到地面，由主动觅食转向伏击。',
      '锯齿牙撕裂、身体后拉加毒腺分泌物共同致伤；口腔细菌至多算帮凶。',
      '圈养雌性曾被证实能孤雌生殖；野外繁殖仍以有性生殖为主。',
    ],
    threats: [
      '弗洛勒斯沿海生境丧失、退化与破碎化',
      '鹿和野猪等猎物被盗猎',
      ...
      gallery: [
        {
          ...
          title: '把空气送进犁鼻器',
          caption: '分叉舌采集化学颗粒，犁鼻器据此辨别方向。一条舌头，就是它阅读世界的方式。',
          focalPoint: { x: 0.72, y: 0.53 },
        },
        {
        ...
        },
        {
          ...
          title: '伏击发生在最后几步之前',
          caption: '大型个体很少主动追击，守在猎物通行的路径上等机会。画面里两者相隔一段距离，胜负通常在最后几步才揭晓。',
        ...
        },
        {
          ...
          title: '真正的卵室藏在假洞之后',
          caption: '守巢由雌性承担；真正的卵室深藏在土丘内部的多腔通道尽头。',
  ...
  },
  {
    ...
    habitats: [
      ...
      },
      {
        name: '次生林、灌丛与相邻草地',
        realm: 'terrestrial',
        description: '也能利用受扰林地和林缘镶嵌；适宜度随植被结构、猎物、体型和地区浮动，与完整原生林仍有差距。',
      },
      {
        name: '种植园、乡村花园与城市水道',
        realm: 'terrestrial',
        description: '小型个体借助共栖鼠类住进农业与城市环境；大型个体仍需要充分的遮蔽和大型猎物，硬化环境容得下幼蛇，撑不起一条巨蟒的一生。',
      },
    ],
    measurements: {},
    diet: {
      ...
      description: '机会性肉食；苏门答腊样本显示食谱随体型显著变化，小个体主要取食鼠类，约 3—4 米后逐渐转向更大的哺乳动物。这份清单出自地区样本，换个流域，菜单便是另一副模样。',
    },
    activity: [
      '多在夜间隐蔽活动，以伏击接近的猎物为主',
    ...
    storySections: [
      {
        ...
        label: '野生型辨识',
        title: '一张会移动的网',
        body: '头顶窄暗线、眼后斜纹与身上相连的黑褐菱形共同织成“网纹”。浅色中心、体侧白斑和自然虹彩随光线明灭；认它就看这张连成一片的网——缅甸蟒那彼此分离的鞍斑是另一种图案。白化与虎纹则是人工选育出的色型。',
      },
      {
        key: 'labial-heat-pits',
        label: '热感窝',
        title: '唇缘的小凹穴，读取温暖猎物',
        body: '上下唇鳞的一排小窝被动感受红外热辐射，并与视觉、气味和触碰信息共同引导转头、攻击和咬后搜索。这套器官只管接收，像一对只听不说的耳朵。',
      },
      {
        key: 'diet-shift',
        label: '体型与食谱',
        title: '身体长大，菜单也跟着换挡',
        body: '苏门答腊胃内容样本中，小蛇主要捕食鼠类；约到 3—4 米体型段后，豪猪、灵长类、鼷鹿和野猪等较大猎物所占比重增加。菜单换了，不同体型的蛇能安身的环境也跟着变。',
      },
      {
        key: 'climbing-and-water',
        label: '树枝与水道',
        title: '会爬低枝，也能跨过海峡',
        body: '幼体轻巧，能沿低枝和灌丛移动；体型增大后更多留在地面和水边。强游泳能力让网纹蟒利用河流、湖泊和城市水道，也帮助它在东南亚岛屿之间铺开广阔却遗传分化的分布。',
      },
      {
        key: 'eggs-and-interval',
        label: '繁殖投入',
        title: '两打卵，隔几年才一窝',
        body: '雌蛇盘绕卵团，静静孵护。北苏门答腊样本平均每窝 24.2 枚，繁殖间隔约 2—4 年；地点、季节、体型和营养都在改写这本繁殖日历，没有哪一行对全种通用。',
      },
      {
        key: 'monitoring-and-trade',
        label: '监测与贸易',
        title: '给隐身的蛇计数',
        body: '沙巴五年的密集河岸调查，平均探测概率仍只有约 20%，单靠野外目击很难估算种群。重复调查、收获样本人口学、来源追踪和遗传单元要一起进入 CITES 无害性判定，才能分清真实的变化与观测的偏差。',
      },
    ],
    keyFacts: [
      '当前接受学名是 Malayopython reticulatus；Python reticulatus 是 IUCN 文件沿用的旧组合。',
      '它是世界最长的现生蛇种；性别、地区和亚种间体型差异很大，普通成体比传闻中的极值小得多。',
      ...
      gallery: [
        {
          ...
          title: '一张网，从头顶延伸到全身',
          caption: '相连网纹是野生型的辨识核心；唇鳞缘那排小凹穴正对着镜头，是它读取温血猎物的窗口。',
        ...
        },
        {
          ...
          title: '小体型更容易走上枝头',
          caption: '幼体和小型个体在低枝与灌丛间穿行；体重渐长，活动的舞台便移回地面和水边。',
        ...
        },
        {
          ...
          title: '鼠类把小蛇带到人类环境边缘',
          caption: '苏门答腊样本里，小蛇的主粮是鼠类。跟着粮仓住进种植园边缘的是它们，大型个体仍要更复杂的林地。',
          focalPoint: { x: 0.62, y: 0.62 },
        },
        {
          ...
          title: '盘绕卵团的雌蛇',
          caption: '北苏门答腊样本平均约 24.2 枚卵，繁殖间隔约 2—4 年；具体到每一窝，数字各有起伏。',
          focalPoint: { x: 0.5, y: 0.57 },
        },
        {
  ...
  },
  {
    ...
    measurements: {
      length: {
        ...
        max: 4.5,
        unit: 'm',
        note: '较常见成体参考范围；雄性通常更大，6 米以上的记录出自历史上的大型雄性',
      },
    },
    diet: {
      types: ['carnivore', 'piscivore'],
    ...
    storySections: [
      ...
      },
      {
        ...
        body: '只有较大成熟雄性会在外鼻孔周围长出软组织与软骨构成的 ghara。野外研究记录到短促水下 POP，并同时记录呼吸、下潜和水面气泡等行为；警戒与巡游时都发过声，叫它求偶扩音器还为时尚早。',
      },
      {
        key: 'connected-river',
        label: '生境',
        title: '保护一只鳄，必须让整条河仍像河',
        body: '深水、浅岸、裸露沙洲与季节洪水共同组成恒河鳄的家园。坝闸既阻断移动，也改变泥沙和植被；抽水、采砂与河岸农业继续压缩筑巢空间。局部补沙能解燃眉之急，长久的生机仍系于自然流量与河道连通。',
      },
      {
        key: 'sandbank-nursery',
        label: '繁殖',
        title: '一片沙洲，同时是产房与育幼场',
        body: '雌性在干季临水沙岸挖穴，通常产约 30—50 枚卵。她会守巢并在孵化时打开巢穴，却不会把幼体含在嘴里搬运——这一点和其他许多鳄类不同。多个巢的幼体可合并成托儿群，由雌性和通常一只大型雄性守护。',
      },
      {
        key: 'counting-boundaries',
        label: '种群',
        title: '650、1,857 与 486，说的是三件不同的事',
        body: 'IUCN 的 300—900 是全球成熟个体估计；昌巴尔 1,857 是 2019 年全部体型的地方计数；486 则是同年的巢数。调查范围、体型标准与方法各不相同，这三个数字只能各用各的。',
      },
      {
        key: 'recovery-with-caveats',
        label: '保护',
        title: '回升的曲线，集中在少数河段',
        body: 'IUCN 把总体趋势记为上升，但恢复高度集中在昌巴尔等少数地点。人工育幼放归曾帮助部分种群，只是历史标记和追踪不足，总体成效难以量化；减少渔网死亡、维护沙洲、恢复连通，这些基础工作无可替代。',
      },
    ],
    keyFacts: [
      'IUCN 当前档案为极危 A2bce、趋势上升；两者分别描述历史衰退等级与评估时的近期方向。',
      '极长窄吻两侧排列大量大小较接近的细牙，水下快速夹鱼是它的强项；对付大型陆生猎物则力有不逮。',
      'ghara 只见于大型成熟雄性：围绕外鼻孔长成的软组织与软骨结构，名字正来自印度语里那种圆肚陶壶。',
      '雌性守巢、开巢；幼体自行下水后聚成由多只成体守护的托儿群。',
      '全球成熟个体估计、地方全部体型计数和巢数各有口径，各说各的事。',
      '主要自持繁殖种群仍集中在印度和尼泊尔；孟加拉国、巴基斯坦的近期记录尚未证实稳定本地繁殖。',
      '高度水栖的恒河鳄照样离不开陆地：沙洲既是晒背场，也是穴巢与幼体的第一段岸线。',
      '人工育幼放归要与河流连通、适宜流量、渔业协作和长期标记监测结合，才可能形成可衡量的恢复。',
    ],
    threats: [
      ...
      gallery: [
        {
          ...
          title: '水下的一声 POP',
          caption:
            '野外研究确认成熟雄性会发出短促 POP；清澈水下的初步观察曾记录快速闭颌与随后腾起的泡云，声源机制尚待验证。',
        ...
        },
        {
          ...
          title: '侧向一击夹住鱼',
          caption:
            '长吻与密集细牙适合在水下迅速夹持小鱼；躯干低而稳，发力全在头颈之间，一击即收。',
          focalPoint: { x: 0.72, y: 0.58 },
        },
        {
        ...
        },
        {
          ...
          title: '先让沙洲重新适合筑巢',
          caption:
            '清除侵入木本植被、局部补沙和测量巢岸，都是地点性的修复手段；真正的生机，仍系于自然流量与河道连通。',
          focalPoint: { x: 0.5, y: 0.57 },
        },
      ],
    },
  ...
  },
  {
    ...
    distribution: {
      ...
      range:
        '广布于大西洋、太平洋、印度洋和地中海的热带、亚热带及部分温带水域，在80多个国家筑巢并使用140多个国家的沿岸水域；幼体利用开放海洋表层漂流带，大幼体和成体多在浅海觅食，再沿跨国迁徙通道往返觅食地与繁殖海滩。所列国家仅为代表，完整范围与迷游记录远多于此。',
    },
    habitats: [
      {
        name: '浅海海草床、藻场、潟湖与礁缘',
    ...
    measurements: {
      length: {
        ...
        max: 122,
        unit: 'cm',
        note: 'NOAA成体3—4英尺展示范围的四舍五入换算；全球最大的个体比这更长。',
      },
      weight: {
        min: 113,
        max: 181,
    ...
    description:
      '绿海龟的甲通常是褐、灰或橄榄色，名字来自绿色脂肪而非绿色外壳。幼体先在开放海洋漂流带生活，许多个体随后转入浅海草床和藻场，以锯齿状短喙剪食植物；许多成熟个体再沿跨国通道往返繁殖区，雌龟回到出生海滩所在区域产卵。IUCN在2025年把全球状态从濒危更新为无危且趋势上升，纳入评估的筑巢量自1970年代总体约增加28%；不过11个区域管理单元中仍有濒危、易危和近危种群，全球的恢复曲线之下，局地的下降仍在继续。',
    storySections: [
      {
        key: 'identity',
        label: '辨识',
        title: '绿色藏在脂肪里',
        body:
          '成体披平滑的褐、灰或橄榄斑驳硬壳，中线五枚椎盾、两侧各四枚肋盾；头相对小，两眼间只有一对大型额前鳞，短圆喙的切缘带细锯齿。名字里的那抹绿藏在皮下的脂肪里，甲色反倒朴素。',
      },
      {
        key: 'life-stages',
        label: '成长',
        title: '从马尾藻漂流带转入浅海草床',
        body:
          '刚出巢幼龟先游向开放海洋，在表层汇聚带和漂浮马尾藻附近生活数年；北大西洋样本显示早期约三至五年偏肉食。较大幼龟随后转入浅海觅食地，许多个体逐渐以海草和藻类为主。“食草”概括的是成年后的主轴；漂泊的幼年，它还是个杂食者。',
      },
      {
        key: 'grazing',
        label: '生态',
        title: '巨型草食动物会重塑海草床',
        body:
          '反复剪食能形成栽培式草斑，并在一些加勒比草床触发补偿生长；但效果取决于密度和草床恢复力。2026年久米岛研究显示，高密度持续啃食也能耗竭孤立草床并反过来限制龟的体况和生长，保护必须同时看住吃草的龟和长草的床。',
      },
      {
    ...
    keyFacts: [
      ...
      'NOAA成体展示范围约长91—122厘米、重113—181千克；全球最大的个体比这更大。',
      ...
      '一只迁徙雌龟曾两次潜到超过135米，近岸样本却有89%—100%的时间待在5米之内；深潜是插曲，浅水是日常。',
      ...
      '在中国，绿海龟是国家一级保护野生动物；IUCN 评级之外，国内与国际的法律保护照旧生效。',
    ],
    threats: [
    ...
    featuredStats: [
      {
        ...
        value: '91—122',
        unit: '厘米',
        note: 'NOAA 3—4英尺展示范围的换算；全球最大甲长超出此列',
      },
      {
        key: 'adult-mass',
        label: '成体质量',
      ...
      gallery: [
        {
          ...
          title: '锯齿状短喙剪食海草',
          caption: '短圆喙的细锯齿切缘适合剪断海草；名字里的那抹绿，藏在皮下的脂肪里。',
        ...
        },
        {
          ...
          title: '迁徙途中浮到水面换气',
          caption: '绿海龟用肺呼吸，迁徙途中也得浮出水面换气；一条路线跨过多国海域，每只龟各有各的走法。',
          focalPoint: { x: 0.62, y: 0.58 },
        },
        {
          ...
          title: '雌龟在夜间覆盖巢室',
          caption: '产卵后，雌龟用后鳍肢回填沙土、扫平巢位，天亮之前不留痕迹。',
        ...
        },
        {
          ...
          title: '黑暗海滩上的远距监测',
          caption: '天然的海向地平线引导幼龟入海；远处的监测员只用受控红光记录，把黑夜完整留给它们。',
  ...
  },
  {
    ...
    distribution: {
      ...
      countries: ['墨西哥'],
      endemicTo: ['墨西哥谷地'],
      range: '历史分布包括霍奇米尔科湖和查尔科湖；现行分类资料把天然分布保守限定在墨西哥城南部霍奇米尔科湖残存的运河与湿地。其他城市水体中的记录来路各异，暂且与这里的原生野生种群分开记账。',
    ...
    habitats: [
      ...
      },
      {
        ...
        realm: 'freshwater',
        description: '传统固定抬高农田之间的狭窄水道仍保留重要湿地结构；经过生态过滤、外来鱼隔离和本土水草恢复的小尺度庇护水道能改善局地条件，整个湖区的康复则要靠更大的一盘棋。',
      },
    ],
    measurements: {
    ...
    diet: {
      ...
      description: '它快速张口并压低舌骨，借进入口腔的水流吸入猎物。霍奇米尔科的野外胃含物研究样本很小，这份食物清单只是轮廓，比例与全貌仍待补充；食物网研究还显示它与外来鲤鱼和罗非鱼存在资源重叠。',
    },
    ...
    description: '墨西哥钝口螈通常不经过多数钝口螈那样的陆栖成体变态，而是在保留外鳃、背尾鳍和水生生活方式的同时达到性成熟。粉白红鳃的形象主要来自圈养色型；野生个体通常是深灰褐至黑褐色，并带有斑驳或金色细点。实验室和宠物缸里的个体数以百万计，霍奇米尔科里的野生支系却在走向消失——两本账，救不了彼此。',
    storySections: [
      {
        key: 'wild-and-captive',
        label: '野生型与圈养型',
        title: '同一张“笑脸”，背后是两条不同的种群故事',
        body: '野生型多为深色斑驳体表；常见的粉白、黑眼个体则多是历史圈养品系中的 white／leucistic 型，与红眼的 albino 型不同。研究用种群还曾引入虎纹钝口螈 DNA。实验室里数量充足、容易繁殖，可它们的基因库里混着别的故事，替不了霍奇米尔科那条野生血脉。',
      },
      {
        key: 'paedomorphosis',
        label: '发育与呼吸',
        title: '成年，仍住在幼体的水下身体里',
        body: '它会正常达到性成熟，却通常保留幼体时期的三对外鳃、背尾鳍和水栖形态，这叫幼态延续。呼吸的活儿由几套器官分担：外鳃之外，皮肤参与气体交换，肺也保留下来，个体还会到水面吞气；实验条件下，一剂甲状腺激素就能诱导变态，“永不变态”的说法由此失准。',
      },
      {
        key: 'suction-feeding',
        label: '摄食与食物网',
      ...
      },
      {
        ...
        label: '再生研究',
        title: '再生是一场按部就班的重建',
        body: '实验研究显示，墨西哥钝口螈能重建完整肢体和尾。这场重建自有章法：伤口闭合、细胞改换状态、芽基成形、组织重新分化；部分心室切除与端脑损伤模型也显示了特定条件下的组织修复。不同组织、损伤方式、年龄与实验条件都会影响结果——再生也会留疤，更拦不住一片受污染、被切碎的湿地失去它的居民。',
      },
      {
        key: 'eggs',
        label: '繁殖',
        title: '精包留在水底，卵分散附在水草上',
        body: '雄体放置胶质精包，雌体用泄殖腔拾取并完成体内受精，随后把胶质卵逐枚或分散地附着在水生植物和水下结构上。常见窝卵数字主要来自圈养记录，野外典型值仍未知；产完卵，成体便转身离去。',
      },
      {
        key: 'chinampa-refuges',
        label: '保护与共生景观',
        title: '修复一条水道，也要让 chinampa 继续有人耕作',
        body: '历史调查密度从 1998 年约每平方千米 6,000 只跌到 2013/2014 年约 35 只；这是两次调查的估计，最新的普查还在路上。chinampa-refugio 以过滤屏障排除外来鱼、改善局地水质，并把传统农业、chinampero 农户和本土水下生境纳入同一恢复网络。至于短期放养试验，离“种群恢复”的结论还有很长的路。',
      },
    ],
    keyFacts: [
    ...
    featuredStats: [
      {
        ...
        value: '6,000 → 约 35',
        unit: '只/平方千米',
        note: '1998 与 2013/2014 的区域调查估计；最新数字仍待新普查',
      },
      {
        key: 'external-gills',
        label: '外鳃',
    ...
    media: {
      ...
      gallery: [
        ...
        },
        {
          ...
          title: '卵逐枚留在水草上',
          caption: '雌性把胶质卵逐个黏附在水草或其他基质上，随后便游走，把孵化交给时间。',
        ...
        },
        {
          ...
          title: '把一段运河变成庇护水道',
          caption: '粗滤障、水质管理和本土植被在小尺度上挡住外来鱼、改善栖息条件；这项工具需要常年维护，才配得上“恢复”两个字。',
  ...
  },
  {
    ...
    habitats: [
      ...
      },
      {
        name: '喀斯特及其他地下水文系统',
        realm: 'freshwater',
        description: '部分评估记录涉及与地表溪流相连的喀斯特洞穴和地下水系；其中哪些属于严格种义的本种，仍待分子核验。',
      },
    ],
    measurements: {},
    diet: {
      ...
      description: '水下机会性肉食，能通过快速张口形成吸力把近距离猎物带入口中。已报道猎物来自拆分前的广义“中国大鲵”记录，严格种义野外食谱缺少系统量化，因此这里只列大类，比例留白。',
    },
    activity: [
      '终生水栖，常利用巨石下和岩岸水下洞穴',
    ...
    description:
      '中国大鲵是大鲵属的水栖两栖动物，成体以宽扁头部、很小的眼、粗糙褶皱皮肤和侧扁尾适应岩石溪流，幼体期的羽状外鳃早已随发育退去。它靠快速张口吸入近处猎物，繁殖期由雄性占据水下巢穴并守护串珠状卵。历史上的 Andrias davidianus 实际包含多个隐蔽谱系，现代养殖转运、逃逸和缺乏筛查的放流又打乱了地理信号；因此“在某地发现大鲵”，未必就是找回本种的原生种群。IUCN 按 2020 操作口径评为极危且持续下降，CITES 将大鲵属列入附录 I。',
    storySections: [
      {
        key: 'species-complex',
        label: '名字与谱系',
        title: '一个旧名字，曾装下多条隐蔽谱系',
        body: '馆藏标本和遗传研究显示，历史上统称 Andrias davidianus 的中国大鲵分成多条长期隔离的谱系，其中一些已经命名为独立物种，另一些仍待研究。严格种义的本种，地盘可能比旧地图画的小；养殖转运和放流，又让今天的采集地点说不清祖籍。',
      },
      {
        key: 'stream-body',
        label: '水下形态',
      ...
      },
      {
        ...
        body: '大鲵快速张开宽口并降低口腔底部，形成吸力，把近处的蟹、虾、鱼、蛙或水生无脊椎动物连同水带入口中。实验支持这种双向、下颌驱动的吸食机制；猎物清单却多整理于物种拆分之前，只能当作参考轮廓。',
      },
      {
        key: 'den-master',
        label: '雄性育幼',
      ...
      },
      {
        ...
        label: '放流与恢复',
        title: '放流之前，先对好血缘',
        body: '2002—2019 年，至少 287,840 只养殖大鲵被放进各地的溪流，其中多数未经充分遗传筛查，普遍建立可持续种群的证据至今缺席。混放暗藏三重风险：谱系杂交、生态替代、病原传播；水样 eDNA、遗传鉴定、健康筛查与长期个体监测必须结伴同行。',
      },
    ],
    keyFacts: [
      ...
      '成体具有宽扁头、小眼、明显侧皮褶和侧扁尾；幼体的三对外鳃早已随发育退去。',
    ...
    featuredStats: [
      ...
      },
      {
        ...
        value: '24 / 97',
        unit: '只 / 处',
        note: '2013—2016 年中国大鲵属范围级调查；发现个体可能来自养殖逃逸或放流，剩余总量仍未知',
      },
      {
        ...
        value: '≥287,840',
        unit: '只',
        note: '2002—2019 年广义中国大鲵口径；野外真正立住脚的有多少，仍无答案',
      },
    ],
    media: {
      ...
      gallery: [
        {
          ...
          title: '一副贴近水底的宽扁身体',
          caption: '小眼、宽头、粗糙皮肤和侧褶是成体的模样核心；那三对羽状外鳃，幼年过后便收起来了。',
        ...
        },
        {
          ...
          title: '一条溪流，连接藏身处与巢穴',
          caption: '巨石空隙、深潭边缘、森林岸坡和连续水流共同构成生境；一条完整的溪，才养得下一尾大鲵。',
        ...
        },
        {
          ...
          title: '夜色中的溪底相遇',
          caption: '夜色里，一只淡水蟹停在大鲵的历史猎物清单之内；这一刻只是相遇，结局留给溪水去写。',
        ...
        },
        {
          ...
          title: '守在卵串旁的“巢穴主人”',
          caption: '守巢、扇水和翻卵都由雄性完成；孵化时长则随水温与环境起伏。',
  ...
  },
  {
    ...
    habitats: [
      ...
      },
      {
        name: '林下幼体水体',
        realm: 'freshwater',
        description: '卵产在潮湿陆地微生境；孵化后由雄蛙把蝌蚪背到林下水体，幼体在水中继续发育。成蛙的生活重心仍在陆上。',
      },
    ],
    measurements: {
      length: { min: 37, max: 47, unit: 'mm', note: '成体吻肛长；雌性通常稍大，后肢不在量程之内' },
    },
    diet: {
      types: ['insectivore'],
      foods: ['小型陆生节肢动物'],
    ...
    storySections: [
      {
        ...
        label: '外形与成长',
        title: '从黑底金纹，换成一身警戒色',
        body: '小幼蛙另有装束：黑色为底，背外侧镶着金色纵纹，长大后逐渐换上较均一的亮黄、橙金或绿乳白色。醒目的成体色是给天敌的警告；至于区分近缘叶毒蛙，还得靠更细的形态特征。',
      },
      {
        key: 'forest-floor',
        label: '活动与鸣叫',
        title: '落叶层是它的舞台',
        body: '金色箭毒蛙白天在极湿低地林的落叶、树根和低矮遮蔽物间活动。雄蛙会发出延续数秒的颤音吸引雌性，也会追逐、扭抱同类；这些行为说明它有领域互动，只是领域究竟有多大，仍是个未知数。',
      },
      {
        key: 'dietary-toxin',
        label: '食物与化学防御',
        title: '一身毒性，是从食物里攒下的',
        body: '它捕食小型陆生节肢动物，把膳食中的生物碱运输并储存在皮肤腺体。圈养繁殖、缺少相关生物碱食物的个体通常没有可检测的蛙毒素；野外捕获个体却能保留多年。究竟哪种哥伦比亚猎物提供蛙毒素，以及蛙如何避免自体中毒，都还没有最终答案。',
      },
      {
        key: 'tadpole-transport',
        label: '繁殖与育幼',
        title: '雄蛙把下一代背到水边',
        body: '雌蛙把一簇卵留在潮湿落叶间；半自然观察中，雄蛙在产卵后短暂返回润湿卵簇，临近孵化时再回来，让幼体爬上背部并运到林下水体。当地约 16 年非系统观察多见一次背 2—9 只；2023 年的 16 只是一笔异常纪录，窝数推断还需更多观察。',
      },
      {
        key: 'narrow-range',
        label: '分布与生境',
        title: '世界地图上，只占哥伦比亚西岸的一小角',
        body: '它只见于考卡省和考卡山谷省太平洋侧的极湿低地林。已知研究地点低至海拔 25 米以下，北界由 DNA 证据向纳亚和尤鲁曼吉流域扩展；北界虽然向北推了，它依旧是地图上一小角的窄域特有种。',
      },
      {
        key: 'conservation',
        label: '保护与治理',
    ...
    keyFacts: [
      ...
      '雄蛙会把孵化后的蝌蚪背到林下水体；16 只是一笔异常纪录，寻常背负多在 2—9 只之间。',
    ],
    threats: [
      ...
      gallery: [
        {
          ...
          title: '落叶层里的觅食',
          caption: '它捕食小型陆生节肢动物；画面里的蚁形猎物是场景示意，真正提供蛙毒素的那一口，研究者还在寻找。',
        ...
        },
        {
          ...
          title: '卵留在潮湿陆地',
          caption: '半自然观察里，雄蛙会短暂返回润湿卵簇；临近孵化再回来接孩子上背，一路送到水边。',
          focalPoint: { x: 0.5, y: 0.5 },
        },
        {
  ...
  },
  {
    ...
    storySections: [
      {
        ...
        title: '招牌锈斑，只属于工蜂和雄蜂',
        body:
          '工蜂与雄蜂的第二腹背板 T2 中央通常是锈褐色，斑块后方和两侧仍有黄色毛；蜂王的 T2 通常整体为黄。蜂王也更大：19—23 毫米，对比工蜂 9—16 毫米和雄蜂 14—17 毫米。锈斑是强辨识提示，可靠鉴定还需结合头颊、其余毛色、地点和专家复核。',
      },
      {
        ...
        title: '它要的是一整年的资源链',
        body:
          '早春蜂王常在林地花和开花木本补能，夏秋工蜂、雄蜂与新蜂王又利用草甸、湿地、稀树草原、林缘和部分花园。花源还必须靠近巢洞与越冬土壤；只在盛夏开花的单一花田，撑不起一个完整的蜂群年轮。',
      },
      {
        key: 'borrowed-burrow',
        label: '巢与越冬',
        ...
        body:
          '巢多藏在废弃啮齿动物洞或其他有遮蔽空腔中，常位于地下约 0.3—1.2 米，也有地表和建筑结构中的例外。冬天留下的是单只已交配新蜂王，蜂群其余成员早已谢幕。本种唯一有文件记录的越冬蜂王，在林内落叶与松土下几厘米被发现；更广的越冬偏好仍主要依据同属研究推断。',
      },
      {
        key: 'annual-colony',
        label: '年度蜂群',
        title: '一位蜂王，从春天重新开始',
        body:
          '创巢蜂王独自产下第一批工蜂；工蜂接手访花、育幼与巢务后，蜂群在夏季扩张。晚夏至初秋出现雄蜂和未交配新蜂王，交配后的新蜂王寻找越冬点；雄蜂、工蜂与旧蜂王在冬前死亡。所谓“一年一代”，说的是蜂群的循环，单只成虫的寿命短得多。',
      },
      {
        ...
        title: '百样花，还要连成四季',
        body:
          '百年博物馆标本的花粉显示它光顾过近百个植物类群，其中找不出一种全域通吃的“必需花”。直接野外观察记录到它振动蔓越莓花取粉；至于番茄授粉效率，本种的同等级直接研究仍属空白。恢复生境的重点，是让当地从早春到秋季都有连续而多样的花。',
      },
      {
        ...
        title: '数照片，数不出一个健康种群',
        body:
          '调查增加后，已知观察点有所增加，但多数地点仍只有一两只记录。遗传研究发现高近交和约 15% 雄性二倍体率；病原体、农药、生境与气候压力又可能相互放大。恢复要同时追踪占域、蜂群产出、遗传、疾病与暴露，照片数量只是其中最浅的一格。',
      },
    ],
    keyFacts: [
      ...
      '野外研究直接观察到它振动蔓越莓花取粉；番茄授粉服务则还停留在推测阶段。',
    ...
    featuredStats: [
      ...
      },
      {
        ...
        value: '约 87',
        unit: '%',
        note: '历史 432 个县/县等价区，对比 2000 年以来 55 个；按出现记录计',
      },
      {
        key: 'colony-cycle',
        label: '蜂群周期',
      ...
      },
      {
        ...
        value: '621,172',
        unit: '公顷',
        note: '六州 14 单元的 ESA 法律指定范围；与当前分布或保护区面积各有所指',
      },
    ],
    media: {
      ...
      gallery: [
        ...
        },
        {
          ...
          title: '借来的地下入口',
          caption: '本种常借废弃兽穴和其他空腔筑巢；画面停在洞口，把地下的秘密留给它们自己。',
        ...
        },
        {
          ...
          title: '没有锈斑的创巢蜂王',
          caption: '蜂王出蛰后依靠早春花源恢复能量、寻找巢址；她的 T2 通体黄色，锈斑是工蜂和雄蜂的标记。',
        ...
        },
        {
          ...
          title: '年度蜂群末期的雄蜂',
          caption: '雄蜂在晚夏至初秋登场，交配之后便在冬前谢幕；采粉筑巢是工蜂的职责。',
  ...
  },
  {
    ...
    distribution: {
      ...
      countries: [],
      range:
        '遗传研究与 USFWS 2024 状态评估把北美迁徙种群视为现存全球种群的祖先来源，并把中南美洲、加勒比及其他北美以外种群解释为后期扩散或归化群体；IUCN 2021 物种评估和 USFWS 当前页面的 Geography 段却沿用更宽的“原生美洲”口径。权威资料边界既不一致，这里便让各地个体保留各自的来历。今天北美东部和西部存在长距离迁徙种群，温暖地区也有定居或仅局部移动种群，亚洲、非洲、欧洲、大洋洲与多座岛屿均有现生记录。地图中心只为聚焦北美迁徙系统，全物种的分布与丰度远比这辽阔。',
    ...
    diet: {
      ...
      description:
        '幼虫依赖乳草类寄主，并从中摄取和保留参与化学防御的强心苷；成虫则是利用多种花蜜植物的广食性访花者。乳草既是产卵基质又是幼虫的口粮；成蝶的花蜜单则宽泛得多。',
    },
    activity: [
      '日行性，依赖环境热量完成飞行与觅食',
    ...
    description:
      '帝王蝶的幼虫只在适宜乳草上生长并积累强心苷，成虫则从多种花蜜植物补能。北美东部长寿秋季世代能跨越数千公里抵达墨西哥高山冷杉林，次年由它们启动、再由后续数代接力完成北返。整个物种在 IUCN 2021 年全球评估中为无危、趋势未知；迁徙亚种 Danaus plexippus plexippus 另评为易危 A2b——全球评级安稳，迁徙现象与区域种群却各有各的险。',
    storySections: [
      {
        ...
        body:
          '四片橙色翅被黑色翅脉分隔，宽黑边缘排列白斑。雌蝶翅脉通常更宽、更深；雄蝶两片后翅各有一个黑色香鳞斑，翅脉相对较细。副王蛱蝶后翅常有贯穿翅脉的横黑线，这一条在帝王蝶翅面上寻不见；自然磨损、角度和光线仍会让单张照片难以可靠鉴定。',
      },
      {
        ...
        body:
          '雌蝶把卵单独产在适宜乳草上，幼虫经过五个龄期取食叶片，并保留乳草强心苷参与化学防御。橙黑警戒色能吓退部分捕食者，另一些天敌却照吃不误。羽化后的成蝶改吸多种花蜜；只种乳草而缺了春秋连续花源，生命史与迁徙照样断链。',
      },
      {
        ...
        body:
          '卵通常约 2—5 天孵化，幼虫五个龄期约 9—18 天，翠绿色裸蛹再经历约 6—14 天。春夏繁殖世代成蝶通常只活 2—5 周；秋季世代进入生殖滞育、积累脂肪，可活 6—9 个月并承担南迁、越冬与翌春第一段北返。把 9 个月安在每一只帝王蝶头上，就把两种生活策略混成了一谈。',
      },
      {
        key: 'relay-migration',
        label: '迁徙与导航',
    ...
    keyFacts: [
      '整个物种 Danaus plexippus 的 IUCN 全球状态为无危；迁徙亚种 D. p. plexippus 另评为易危 A2b，二者各说各的事，引用时需分开。',
      '成虫翼展约 93—105 毫米，平均体重约 0.5 克；本次未找到可靠的成虫头尾体长范围。',
      '雄蝶每片后翅各有一个黑色香鳞斑，雌蝶翅面素净、翅脉通常更宽；副王蛱蝶那种后翅横黑线，在帝王蝶身上寻不见。',
      ...
      gallery: [
        {
          ...
          title: '后翅上的两枚雄性标记',
          caption: '雄蝶两片后翅各有一枚香鳞斑，雌蝶翅面素净；照片鉴别还需把角度与磨损一并考虑。',
        ...
        },
        {
          ...
          title: '乳草叶缘的专食幼虫',
          caption: '乳草是幼虫寄主和强心苷来源；前后那两对肉质触须是感觉器官，与毒刺无关。',
        ...
        },
        {
          ...
          title: '翠绿裸蛹',
          caption: '帝王蝶以尾突倒挂在丝垫上，一身翠绿即是全部行装；蛹期通常约 6—14 天。',
        ...
        },
        {
          ...
          title: '湖岸把远行者暂时聚到一起',
          caption: '湖岸和半岛常成为迁徙途中的集结与补能地；画面是场景重构，真实的路线每只蝶各不相同。',
        ...
        },
        {
          ...
          title: '冷杉冠层下的越冬微气候',
          caption: '多数个体在冷凉的晨间闭翅停栖；真正的越冬种群规模，要靠地面与航拍的专门计数。',
          focalPoint: { x: 0.62, y: 0.5 },
        },
      ],
    },
  ...
  },
  {
    ...
    measurements: {
      length: {
        max: 2.4,
        unit: 'm',
        note: '群体最大直径的公众资料上限；现代残存枝丛常小得多，单只珊瑚虫更远小于此',
      },
      height: {
        max: 1.2,
        unit: 'm',
    ...
    description:
      '鹿角珊瑚能快速分枝并通过断枝扩展克隆枝丛，但克隆的枝丛长得再多，也添不进有性繁殖才能带来的新基因。白带病引发的历史崩落、不断加剧的海洋热浪、酸化、污染与沉积、藻类竞争、物理破坏和低基因个体密度共同限制恢复；苗圃、基因库与移植能避免局地消失，却必须与减排和改善礁区环境并行。',
    storySections: [
      {
        ...
        body:
          '它的枝条直或略弯，恢复计划记录枝径约 0.25—5 厘米；组织呈金黄至中褐色，正在生长的枝尖自然较浅。宽扁的板状枝更像麋角珊瑚，整片惨白也可能是白化或组织脱落——认它，要看活组织的颜色、枝径与珊瑚杯的排布。',
      },
      {
        ...
        title: '一片枝丛，可能同属一个基因',
        body:
          '每个可见群体由许多遗传相同的珊瑚虫组成；断枝再附着会形成同一基因个体（genet）的新分株（ramet），多个分株又会交错成连续枝丛。覆盖度可以增长而基因型原地踏步——这正是恢复既要扩增珊瑚量、也要追踪遗传多样性的原因。',
      },
      {
      ...
      },
      {
        ...
        body:
          '断枝在稳定硬底上可形成克隆群体；每年少数夜晚，成熟群体也会把卵和精子释放到水柱中。虽然同一群体同时产生两类配子，通常仍需不同基因个体交配。如今范围内有效有性招募几乎缺席，稀疏的基因个体又进一步压低了受精机会。',
      },
      {
        ...
        body:
          '1980 年代白带病使历史优势种大规模崩落；疾病、风暴和热异常持续造成脉冲式死亡。2023 年佛州创纪录热浪又重创野生、苗圃与移植群体。局地可在平静年份缓过来，只是扰动来得越来越密，枝条生长和断枝补充追不上损失。',
      },
      {
        key: 'restoration-boundaries',
        label: '恢复',
        title: '苗圃在争取时间，海洋降温另需良方',
        body:
    ...
    keyFacts: [
      ...
      '交错的圆柱枝在中浅水礁形成三维庇护空间；枝条、分株与基因个体各是一本账。',
      'IUCN 全球等级为极危；美国 ESA 法律状态仍为受威胁，两套体系各有各的口径。',
    ],
    threats: [
      '海洋升温、海洋热浪与白化',
      '白带病等疾病及温度—疾病协同',
    ...
    featuredStats: [
      ...
      },
      {
        ...
        value: '5—20',
        unit: '米',
        note: '局地可更浅；罕见记录可深至约 60 米，丰度随水深变化很大。',
      },
      {
        ...
        value: '约 97',
        unit: '%',
        note: 'NOAA 对 1980 年代以来白带病相关种群崩落的范围级概述，出自区域综合而非逐株普查。',
      },
      {
        key: 'form',
        label: '生命形态',
      ...
      gallery: [
        {
          ...
          title: '圆柱枝端的生长点',
          caption: '浅色活跃枝尖是健康的模样之一；轴向和辐射珊瑚杯的排布，是分类学家辨认它们的线索。',
        ...
        },
        {
          ...
          title: '由许多枝条织成的庇护空间',
          caption: '枝丛织出复杂的三维迷宫，小鱼在枝间找到落脚处；数枝条容易，数清基因个体难。',
  ...
  },
  {
    ...
    distribution: {
      ...
      range:
        '分子系统学支持狭义海月水母出现于北海、波罗的海、黑海、里海、东北大西洋、格陵兰与北美东北部，并有南美和西北太平洋记录；当前证据更支持其原生于东北大西洋，部分域外种群可能来自引入。过去写作“全球广布”的许多记录，如今多划给广义海月属或近似种——照片认不出它们之间的差别。',
      center: { lat: 56, lng: 4 },
    },
    habitats: [
      {
      ...
      },
      {
        name: '半封闭海湾、峡湾与河口',
        realm: 'marine',
        description: '可利用从正常海水到较低盐的沿岸环境；耐受范围和季节节律因种群而异，一池一测的实验阈值，套不到每一片海。',
      },
      {
        name: '水下硬质附着面',
        realm: 'marine',
    ...
    diet: {
      ...
      description:
        '伞体脉动产生的水流把小型猎物带向伞下、伞缘触手和口腕；刺细胞、黏液与纤毛共同完成捕获和输送。食谱随体型、地点和季节显著变化，鱼苗只是偶得的加餐。',
    },
    activity: [
    ...
    description:
      '海月水母的透明伞下常能看见四枚马蹄形性腺、四条口腕和细密的伞缘触手。它的神经系统是一张分散的网，通常由八个缘感器协调脉动；同一次收缩既推动身体，也把浮游猎物带向捕获面。成体有性繁殖产生浮浪幼体，幼体附着成水螅体，再经横裂释放碟状幼体。2021 年修订把过去混在“海月水母”名下的材料拆成了许多形态重叠的海月属物种假说——四枚马蹄环是好线索，却认不出这一种和那一种，分类学家还得上分子手段。',
    storySections: [
      {
      ...
      },
      {
        ...
        body:
          '典型成体伞径约 15—30 厘米，透明伞下常见四枚蓝粉色马蹄形性腺和四条褶皱口腕，边缘排列数百条细小触手。八个缘感器身兼平衡与感光，与神经网一起指挥每一次脉动——这套系统没有中央大脑，却把身体管得井井有条。',
      },
      {
        ...
        body:
          '伞缘收缩把水向后推出，弹性回弹又为下一次脉动蓄势。实验流场显示，回弹阶段形成的涡环可被下一次收缩回收，增加单次周期的推进收益；同一套水流还把猎物送到伞下与触手边——游泳即觅食，一举两得。',
      },
      {
        key: 'variable-diet',
        label: '浮游捕食',
        title: '桡足类常上菜单，鱼苗算加餐',
        body:
          '缘触手、伞下表面和口腕会截留小型甲壳类及其他浮游动物，再由黏液和纤毛运向口部。孵育实验记录过早期鱼苗；波罗的海的野外研究里，主角却是枝角类、软体动物幼体和桡足类，未见鱼卵鱼苗。一处一季的胃内容物，只是全物种菜单的一个切片。',
      },
      {
        ...
        body:
          '成熟水母有性繁殖后，浮浪幼体寻找表面附着并变成毫米级水螅体。水螅体可出芽扩增，也会把身体横向分节成横裂体，再逐枚释放八辐的碟状幼体；碟状幼体继续生长，才长成成体熟悉的圆伞和性腺。触发横裂的温度、盐度与微生物信号，各海域各有各的配方。',
      },
      {
        key: 'monitor-before-judging',
        label: '监测与保护',
        title: '一片海湾的拥挤，说明不了整个海洋',
        body:
          'IUCN 尚未对狭义海月水母完成全球评估，全球趋势因此成谜。短冬、升温、盐度变化、人工硬底和污染都在改变不同生命阶段的处境，实验结果与种群反应却各有说法。可靠的监测要把影像、水样、环境条件、底栖水螅体调查与分子凭证串成一条线，一次海湾边的拥挤只是这条线上的一格刻度。',
      },
    ],
    keyFacts: [
      'WoRMS 接受 Aurelia aurita 为有效种；2021 年修订为海月属提出 28 个物种假说，但部分名称和边界仍有争议。',
      '成体典型伞径约 15—30 厘米，较大个体可接近 40 厘米；四枚马蹄形性腺醒目，种级鉴定却还需地点、标本与分子数据帮忙。',
      '神经系统是一张分散的网；八个缘感器与它协作，管起游泳起搏、平衡和感光。',
      '实验估算，回收涡流的能量能让每个游泳周期多前进约 30%、运输成本省下约 48%——数字来自水槽，野外的个体各有出入。',
      '水螅体附着生活并可克隆扩增；横裂体释放碟状幼体，碟状幼体才继续发育成自由游泳的成体。',
      '蜇刺通常轻微到难以察觉，敏感体质仍可能皮肤发红；海边遇到认不清水母，欣赏就好。',
    ],
    threats: [],
    conservationActions: [
    ...
    featuredStats: [
      ...
      },
      {
        ...
        value: '8',
        unit: '个',
        note: '参与游泳起搏、平衡与感光；八个哨所，共用一张神经网络',
      },
      {
        key: 'red-list',
        label: 'IUCN 全球状态',
        value: 'NE',
        note: '尚未评估；无危、稳定、增加这些词都还轮不到它',
      },
    ],
    media: {
      ...
      gallery: [
        {
          ...
          title: '四枚马蹄环',
          caption: '性腺环与四条口腕是醒目的线索；至于它姓甚名谁，还得请地点、凭证标本和分子数据来作证。',
          focalPoint: { x: 0.52, y: 0.49 },
        },
        {
          ...
          title: '沿岸水层的旅居者',
          caption: '狭义本种的分子记录跨越北大西洋及若干域外水域；“全球海月皆一家”的旧说，已被基因数据改写。',
        ...
        },
        {
          ...
          title: '一边脉动，一边把猎物带近',
          caption: '伞体一收，水流便把小型浮游猎物送向伞下的捕获面。画面是机制示意，真实的食谱随季节与海域变化。',
        ...
        },
        {
          ...
          title: '水母之前，先附着在硬底上',
          caption: '水螅体先安家出芽，再横裂出一叠盘片，逐枚放飞碟状幼体；圆伞水母的一生，从这毫米级的起点开始。',
        ...
        },
        {
          ...
          title: '把碎片拼成一条趋势线',
          caption: '影像、水样、环境条件与分子凭证互相补足，才能读出海月的长期走势；单次观察只是一帧快照。',
          focalPoint: { x: 0.58, y: 0.52 },
        },
      ],
    },
  ...
  },
  {
    ...
    habitats: [
      ...
      },
      {
        name: '红树林边缘与潮沟',
        realm: 'marine',
        description: '常见于红树林旁和林间潮沟的软泥面，也可利用有植被遮阴、混有较粗颗粒的泥质底；林缘的开阔泥面同样是它们的地盘。',
      },
      {
        name: '上部潮间带洞穴',
        realm: 'terrestrial',
    ...
    storySections: [
      {
        ...
        label: '分类与名称',
        title: '名称换了，螃蟹没有换',
        body: '“Uca spp.”是旧招潮蟹大属的泛称，罩着许多物种。2016 年系统修订把 Tubuca 提升为属，旧文献的 Uca arcuata 与 Uca (Tubuca) arcuata，如今都归到同一接受名 Tubuca arcuata；更早的原始组合则写作 Ocypode (Gelasimus) arcuata。',
      },
      {
      ...
      },
      {
        ...
        label: '垂直挥螯',
        title: '举起来的是信号',
        body: '雄蟹会朝附近的雌蟹定向抬起主螯，身边无人时也照样挥舞，像在向整片泥滩广播。日本样地里，所有成功的洞内交配之前都有定向挥螯；泥面上的交配则偶尔省去这一步。“招潮”只是个形象名字——潮水决定它何时上泥面，巨螯可请不动海。',
      },
      {
        key: 'mud-chimney',
        label: '洞口建筑',
        title: '洞口那圈泥墙',
        body: '雌雄、幼蟹和成蟹都能把洞口周围的湿泥堆成数厘米高圆筒，小个体与雌蟹在一处日本样地更常建造。选择实验中，无洞游走的蟹较少进入带烟囱的洞，说明这圈低墙能帮助守住珍贵的潮间带避难所。',
      },
      {
        key: 'deposit-feeding',
        label: '退潮饭桌',
      ...
      },
      {
        ...
        label: '幼生与保护',
        title: '幼生乘流，保护要跨过河口',
        body: '雌蟹把卵抱在腹部下方，孵化后的幼生进入水体。线粒体记录显示台湾海峡冰期陆桥曾促成南北分化，今天的黑潮等暖流又可能在繁殖季推动扩散。护住一只蟹，得护住一张跨河口的网络：泥滩水文、清洁水质，加上跨地区的标准化调查。',
      },
    ],
    keyFacts: [
      ...
      '北方 N 与广布 W 线粒体支系记录着历史隔离和海流扩散；它们仍属同一个物种。',
    ],
    threats: [
    ...
    featuredStats: [
      {
        ...
        value: '约 3',
        unit: 'cm',
        note: '量的是背甲宽；已核实的分类凭证最宽 40.2 毫米',
      },
      {
        key: 'major-claw-share',
        label: '大型雄蟹主螯',
        value: '最高近 40%',
        note: '占全身体重的比例；数字出自日本大野川种群，各地各有出入',
      },
      {
        key: 'chimney-height',
        label: '常见泥烟囱',
      ...
      },
      {
        ...
        value: '>5',
        unit: '年',
        note: '大野川种群由体型结构与 3.5 年饲养结果推断；全种寿命仍待更多数据',
      },
    ],
    media: {
      ...
      gallery: [
        ...
        },
        {
          ...
          title: '潮水退去，泥滩成为活动地面',
          caption: '软泥、潮沟、植被边缘与可掘洞的沉积层，共同组成它们的家；画面里的几只蟹，各守各的洞口。',
        ...
        },
        {
          ...
          title: '两只小螯轮流筛过泥面',
          caption: '雌蟹用两只小螯轮流把表层泥送进嘴里；筛下的泥粒散在身前，像撒了一地小小的圆饼。',
          focalPoint: { x: 0.54, y: 0.52 },
        },
        {
          ...
          title: '举起来的是信号',
          caption: '垂直挥螯可以面向附近的雌蟹，也可以向整片泥滩广播；至于雌蟹答不答应，还得看它自己的心意。',
          focalPoint: { x: 0.48, y: 0.5 },
        },
        {
          ...
          title: '在同一个潮位窗口读懂变化',
          caption: '可靠的趋势要靠固定潮位、季节与样方，同步记录水质、底质和出洞率；洞口数与个体数之间，还隔着一层换算。',
          focalPoint: { x: 0.52, y: 0.58 },
        },
      ],
    },
  ...
  },
  {
    ...
    distribution: {
      ...
      range:
        '2026 年种界下，狭义 Manis pentadactyla 包括以台湾为模式产地的指名种群和海南 pusilla 谱系，主要分布于中国南部、东部及东南亚。过去归入本种的尼泊尔、藏南和印度东北部种群现属 Manis aurita；缅甸北部可能接触区及东南亚国家级边界仍需有凭证的遗传与形态采样复核。旧 MDD 国家列表和 IUCN 2019 范围仍停留在拆分前的口径，与这张狭义种地图之间还隔着一次更新。',
    ...
    habitats: [
      ...
      },
      {
        ...
        realm: 'terrestrial',
        description:
          '会走进果园、农垦地和聚落边缘觅食；只是道路、犬只、兽夹、农药和开发的风险，也随脚印一起靠近。',
      },
    ],
    measurements: {
      length: {
    ...
    diet: {
      ...
      description:
        '专食社会性昆虫，以嗅觉定位蚁巢或白蚁巢，用发达前爪打开土壤、朽木或巢体，再以细长黏性舌取食；猎物组成随地区、季节和可利用巢穴而变。一只动物的胃，装不下整个物种的菜单。',
    },
    activity: [
      '以陆栖和掘洞生活为主，前爪用于建立休息洞与打开社会性昆虫巢',
      '台湾材料多记录傍晚至夜间出洞，白天在休息洞隐蔽；其他地区的作息表仍待记录',
      '通常独居，繁殖、雄性造访育幼洞及母兽携带单仔时例外',
      '在活动范围内轮换多个休息洞，洞穴可被不同个体共享并跨季节重复利用',
      '受威胁时蜷成鳞球护住柔软的腹面；这身铠甲挡得住猛禽利爪，却挡不住人手和犬群的持续围攻',
    ],
    tags: [
      'IUCN极危',
      'CITES附录I',
    ...
    storySections: [
      {
        ...
        body: '2026 年基因组、模式标本和形态证据把南喜马拉雅的 Manis aurita 恢复为独立种；它与狭义中华穿山甲约在 180 万年前分化。旧资料中尼泊尔、藏南和印度东北部的记录从此划归新种名下，缅甸北部的边界还要补采样才能落笔。',
      },
      {
        key: 'scales-and-claws',
        label: '独特身体',
        title: '一身角蛋白瓦片，一对开路前爪',
        body: '角蛋白鳞片像瓦片般覆盖头背、躯干和尾部，腹面仍柔软；圆锥形头、明显耳廓和五爪前肢构成狭义种的安全图像锚点。粗壮的前爪负责挖洞和撬开蚁巢，牙齿则退居次要。',
      },
      {
        key: 'burrow-is-not-individual',
        label: '监测边界',
        title: '洞口易数，动物难数',
        body: '无线电追踪显示一只个体可轮换数十个休息洞，同一洞也会被不同个体共享并跨季节重用；压实的洞口甚至可能仍在使用。洞穴能提示它们来过；要把洞口数换算成种群密度，还得记下检测概率和重复调查的努力。',
      },
      {
        key: 'selective-myrmecophagy',
        label: '选择性觅食',
        title: '挑食的蚁巢猎人',
        body: '香港一只幼体胃中超过 2.6 万件猎物支持直接打开树上或地表蚁巢，台湾排遗又显示猎物组成随季节改变。两万六千件的惊人数字出自单一个体的胃，当作每日食量便夸大了；站得住脚的结论是：专食、挑剔、因地因时而变。',
      },
      {
      ...
      },
      {
        ...
        label: '保护链条',
        title: '卷成球，挡不住一条贸易链',
        body: 'IUCN 怀疑拆分前广义种在三个世代下降超过 80%，CITES 附录 I 之后非法贸易仍未绝迹。恢复需要供应链执法与种级法证，也需要连续生境、标准化监测、犬只和道路管理、规范救伤放归及社区需求降低同时推进。',
      },
    ],
    keyFacts: [
      ...
      '核心食物是蚂蚁和白蚁，猎物选择随地区与季节变化；单一个体的胃内容物撑不起每日食量的推断。',
      '个体轮换多个休息洞，洞穴还会被共享、复用；从洞口数到种群密度，中间隔着一道换算。',
    ...
    featuredStats: [
      {
        ...
        value: '约 1.8',
        unit: '百万年',
        note: '2026 年基因组时钟均值，95% 置信区间约 1.3—2.5 百万年；分化时间早于现存种群',
      },
      {
        key: 'iucn-decline',
        label: 'IUCN 怀疑三个世代下降',
        value: '>80',
        unit: '%',
        note: '2019 年拆分前评估，三个世代约 21 年、主要归因于捕猎和非法贸易；狭义种的独立重算仍待进行',
      },
      {
        key: 'china-records',
        label: '中国确认发现记录',
      ...
      },
      {
        ...
        value: '1',
        unit: '仔',
        note: '依据台湾官方行动计划和一只雌兽连续两年的单仔记录；例外情形仍可能存在',
      },
    ],
    media: {
      ...
      gallery: [
        {
          ...
          caption: '台湾指名种群的圆耳、重叠鳞片和五爪前肢清晰可辨；想靠数鳞片行数分辨两个近缘种，分类学家已证明此路不通。',
          focalPoint: { x: 0.48, y: 0.54 },
        },
        {
          ...
          caption: '次生林、竹林、草地与可挖掘的黏壤土，共同提供觅食和休息的条件；画面里那片裸露的松软土面，正是它最爱下手的地方。',
        ...
        },
        {
          ...
          title: '舌头探进一道缝隙',
          caption: '香港一只幼体的胃内容物与台湾排遗，共同勾勒出一份挑剔而随季节变化的蚁白蚁食谱；画面是觅食机制的示意。',
        ...
        },
        {
          ...
          title: '一只幼仔，在多个育幼洞之间长大',
          caption: '台湾野外个案记录了母兽背着独仔辗转多个育幼洞；“一胎一仔”是目前的稳健图景，具体天数则来自那只被长期追踪的雌兽。',
        ...
        },
        {
          ...
          title: '一次拍到，只是一次检测',
          caption: '相机陷阱、重复调查与遗传证据合力才能估出趋势；单张照片只是一帧快照，快照拼不成全景。',
          focalPoint: { x: 0.52, y: 0.58 },
        },
      ],
    },
  ...
  },
  {
    ...
    distribution: {
      ...
      countries: [],
      range:
        '分布于印度洋、西太平洋和红海的热带、亚热带沿岸与岛屿水域，行踪跟着可利用的海草床走，碎成大小悬殊的斑块；澳大利亚保有最大的区域种群。中国大陆南海近岸属于历史分布区，两轮大范围访谈研究支持当地种群已经功能性灭绝。',
    },
    habitats: [
      {
        name: '热带与亚热带浅海海草床',
        realm: 'marine',
        description:
          '多数核心生境位于约 20 米以内、阳光够得到海底的沿岸浅水。细沙或泥沙上的海草是主要口粮；一片草床的面积、草种和营养好坏，决定它们留下还是转移。',
        isPrimary: true,
      },
      {
        name: '海湾、潟湖与红树林水道',
    ...
    diet: {
      ...
      description:
        '儒艮用覆满触须的下弯吻部探查海底，再以分成两叶的肌肉质上唇裁下叶片，或把整株连根拔起。海草是主食；部分地区的个体还会添些藻类、海鞘等大型无脊椎动物，各家菜单略有不同。',
    },
    activity: [
      '昼夜均可活动',
      '浅潜啃食海草并定期浮出换气',
    ...
    description:
      '儒艮是儒艮科唯一现生种，也是终生泡在海里的大型草食哺乳动物。宽阔下弯的吻部、分成两叶的上唇和水平的新月形尾鳍，都是贴着海底吃饭的装备。现存种群横跨印度洋与西太平洋，却在许多海岸散落而稀少。刺网兼捕、直接捕杀、船撞与海草床退化，一层层压在本就缓慢的生活史上。',
    storySections: [
      {
        ...
        body:
          '儒艮身体粗壮流线，两枚短前鳍肢划水，一对水平尾叶推进；后肢已彻底退化，背面光洁无鳍。海牛属拖着圆桨状的尾，海豚多有吻突和背鳍，儒艮的尾则收成一弯新月。上唇向下弯、分成两叶，吻缘一圈触须替它探查嘴边的草床。成年雄性和部分高龄雌性的门齿会露成短牙，只是隔着一层海水，远远往往认不出来。',
      },
      {
        ...
        title: '一条食痕，只记录一次经过',
        body:
          '儒艮偏选纤维低、氮含量高的海草，用上唇夹取叶片，或连根带地下茎一起拔起，在沙泥底犁出蜿蜒的食痕。反复啃食会改写草床的高度、更新节奏和斑块格局。想弄清一条食痕出自谁口、当天吃了多少、这片海域住着多少只，研究者得另找办法。',
      },
      {
        ...
        title: '草床改变，活动范围也会改变',
        body:
          '有些个体守着相邻的海湾活动，有些会跨过较深的水域寻找新草床。澳大利亚一项跟踪 70 只个体的研究，记录到最远离捕获点 560 千米的移动：长途旅行的本领确凿，至于各种群是否沿固定路线年年往返，答案各不相同。洪水、气旋和海洋热浪削弱海草时，个体可能离开故地、推迟繁殖，也可能因饥饿死去。',
      },
      {
        ...
        title: '一只幼仔，要用母兽数年来养',
        body:
          '雌性通常到 6—17 岁才第一次当母亲，妊娠约 12—14 个月，每胎多为一仔。幼仔在水下吸乳，跟母亲同游 1—2 年；即便一切顺利，下一胎也常要再等 3—7 年。就算自然死亡压到最低，种群理论最大年增长率也只有约 5%；每一位成年成员的离去，都要很多年才补得回来。',
      },
      {
        ...
        body:
          '儒艮一边挑选、拔取海草，一边在斑块间穿行，就这样重塑海草群落，身上还可能带着海草的繁殖体，把相隔的草床连成一气。海草床同时是幼鱼和无脊椎动物的育幼场，能稳住沉积物，也在默默储存蓝碳。许多沿海社群把儒艮织进了生活与文化传统；这样的老相识，理应坐上保护方案的讨论桌。',
      },
      {
        ...
        title: '连续多年无确认记录之后',
        body:
          '2022 年的研究访问了 788 名渔民并汇总历史记录，2008 年之后再寻不到确认记录，于是判定中国大陆近岸已失去能维持繁殖的种群。2025 年第二轮访谈覆盖 841 人，记下一宗受访者报告的 2021 年疑似兼捕，结论依然是功能性灭绝。这个词说的是种群状态：个别游荡者仍可能出现，能传宗接代的群体却迟迟未归。核验新证据的工作要继续，南海海草床的修复和兼捕管控也要继续。',
      },
    ],
    keyFacts: [
      '儒艮是儒艮科唯一现生种；现生海牛目另外三种都属于海牛科海牛属。',
      '水平的新月形尾鳍有别于海牛属的圆桨状尾，背上也没有鲸豚那样的背鳍。',
      'CMS 资料概括成体可达约 3 米、500 千克；那是少数大个体才够得着的上限。',
      '昆士兰资料概括成体每天摄食约 30 千克海草，摄入量随个体和草床条件浮动。',
      '已记录个体可活到约 70 岁；这是物种的寿命量级，落到每只头上长短各异。',
      '妊娠约 12—14 个月，通常一胎一仔，幼仔随母 1—2 年，两胎常相隔 3—7 年。',
      'IUCN 全球评估为 VU、decreasing、2015、A2bcd+4bcd；2019 年发布的是修订版，评估年份仍是 2015。',
      '全球成熟个体总数未知；区域估计各有方法与年份，简单相加凑不出可靠的全球数字。',
      '中国两轮大范围访谈研究支持功能性灭绝；出现疑似记录或游荡个体时，谈恢复还需要更多证据。',
    ],
    threats: [
      '刺网及其他渔具造成兼捕、缠绕和溺亡',
      '直接捕杀、偷猎与不可持续利用',
    ...
    featuredStats: [
      {
        ...
        label: '泰国成熟个体均值约',
        value: '2.5 m / 250 kg',
        note: '来自泰国地区研究；概览给出的最大值约 3 米、500 千克',
      },
      {
        key: 'gestation',
        label: '妊娠期约',
      ...
      gallery: [
        {
          ...
          title: '用下弯吻部贴近草床',
          caption: '分叶上唇和吻缘触须先挑后夹，海草就这样进了口；一天的饭量取决于草床的丰俭。',
          focalPoint: { x: 0.46, y: 0.58 },
        },
        {
          ...
          title: '由斑块连成的海草家园',
          caption: '海草床由一块块斑块拼成，面积、连通性和草种质量决定儒艮在哪里安家、往哪里赶路。',
        ...
        },
        {
          ...
          title: '只把鼻孔送出水面',
          caption: '儒艮用肺呼吸，隔一阵便把吻顶送出水面换气；鲸类高高竖起的喷气柱，在这里换成了浅浅一露。',
        ...
        },
        {
          ...
          title: '一瓶海水里的线索',
          caption: '环境 DNA 能提示这片海近期是否有儒艮经过；要把线索坐实成结论，还须重复采样，加上航空调查、影像和现场记录。',
